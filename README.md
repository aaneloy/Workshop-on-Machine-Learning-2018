...
## Why Machine Learning?
 <dt>Machine Learning can be used in detecting anomalies, recommending new products, enhancing customer services and a lot of things. In fact, with the amount of data that is available along with the exceptional computing power machine learning can prove to be extremely useful for future. 
...
E.g Youtube , Netflix, Spotify recommendations, FB instagram ads, gmail, Disease Identification/Diagnosis, Weather Forecasting, Video Surveillance, Online Customer Support(chatbots), Online fraud detection, Autonomous driving, Image Recognition, Object detection, Speech recognition in Alexa, Siri etc.</dt>
...
Supervised learning is where you have input variables (x) and an output variable (Y) and you use an algorithm to learn the mapping function from the input to the output.
                          ...
                          ```
<p align="center">
  <img src="https://github.com/NeloyNSU/Workshop-on-Machine-Learning-2018/blob/master/Images/2.png">
</p>
